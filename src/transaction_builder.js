...
function prepareInput(input, kpPubKey, redeemScript, witnessValue, witnessScript) {
    ...
    if (redeemScript && witnessScript) {
        ...
        if (!expanded.pubKeys)
            throw new Error(expanded.scriptType + ' not supported as witnessScript (' + bscript.toASM(witnessScript) + ')');
        ...
        if (!expanded.pubKeys)
            throw new Error(expanded.scriptType + ' not supported as redeemScript (' + bscript.toASM(redeemScript) + ')');
